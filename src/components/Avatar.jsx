...
export function Avatar({ isAboutOpen }) {
  // const { animation } = props.animations;
  ...
  const { actions } = useAnimations(
    [breathingAnimation[0], dancingAnim[0]],
    group
  );
...
useGLTF.preload("models/66004d88f66d96389dbbc4d.glb");
